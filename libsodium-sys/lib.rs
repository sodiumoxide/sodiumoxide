...
pub const crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_SENSITIVE: c_ulonglong =  33554432;
pub const crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_SENSITIVE: c_ulonglong =  1073741824;
...
extern {
  ...
  pub fn crypto_pwhash_scryptsalsa208sha256(out: *mut c_uchar,
                                            outlen: c_ulonglong,
                                            passwd: *const c_char,
...
fn test_crypto_pwhash_scryptsalsa208sha256_saltbytes() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_saltbytes() } == crypto_pwhash_scryptsalsa208sha256_SALTBYTES)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_strbytes() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_strbytes() } == crypto_pwhash_scryptsalsa208sha256_STRBYTES as size_t)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_opslimit_interactive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_opslimit_interactive() } == crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_INTERACTIVE)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_memlimit_interactive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_memlimit_interactive() } == crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_INTERACTIVE)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive() } == crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_SENSITIVE)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive() } == crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_SENSITIVE)
}
#[test]
...
fn test_crypto_pwhash_scryptsalsa208sha256_ll_1() {
    ...
    let ret = unsafe { crypto_pwhash_scryptsalsa208sha256_ll(password.as_ptr(),
