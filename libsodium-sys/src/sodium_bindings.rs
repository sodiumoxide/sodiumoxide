...
pub const crypto_vrf_ietfdraft03_PUBLICKEYBYTES: u32 = 32;
pub const crypto_vrf_ietfdraft03_SECRETKEYBYTES: u32 = 64;
pub const crypto_vrf_ietfdraft03_SEEDBYTES: u32 = 32;
pub const crypto_vrf_ietfdraft03_PROOFBYTES: u32 = 80;
pub const crypto_vrf_ietfdraft03_OUTPUTBYTES: u32 = 64;
pub const crypto_vrf_PUBLICKEYBYTES: u32 = 32;
pub const crypto_vrf_SECRETKEYBYTES: u32 = 64;
pub const crypto_vrf_SEEDBYTES: u32 = 32;
pub const crypto_vrf_PROOFBYTES: u32 = 80;
pub const crypto_vrf_OUTPUTBYTES: u32 = 64;
pub const crypto_vrf_PRIMITIVE: &'static [u8; 12usize] = b"ietfdraft03\0";
...
extern "C" {
    pub fn crypto_vrf_ietfdraft03_publickeybytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_secretkeybytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_seedbytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_proofbytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_outputbytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_keypair(
        pk: *mut libc::c_uchar,
        sk: *mut libc::c_uchar,
    ) -> libc::c_int;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_keypair_from_seed(
        pk: *mut libc::c_uchar,
        sk: *mut libc::c_uchar,
        seed: *const libc::c_uchar,
    ) -> libc::c_int;
...
extern "C" {
    pub fn crypto_vrf_ietfdraft03_is_valid_key(pk: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_prove(
...
extern "C" {
    pub fn crypto_vrf_ietfdraft03_verify(
...
extern "C" {
    pub fn crypto_vrf_ietfdraft03_proof_to_hash(
        hash: *mut libc::c_uchar,
        proof: *const libc::c_uchar,
    ) -> libc::c_int;
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_sk_to_pk(pk: *mut libc::c_uchar, sk: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_vrf_ietfdraft03_sk_to_seed(seed: *mut libc::c_uchar, sk: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_vrf_publickeybytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_secretkeybytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_seedbytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_proofbytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_outputbytes() -> usize;
}
extern "C" {
    pub fn crypto_vrf_primitive() -> *const libc::c_char;
}
extern "C" {
    pub fn crypto_vrf_keypair(pk: *mut libc::c_uchar, sk: *mut libc::c_uchar) -> libc::c_int;
}
extern "C" {
    pub fn crypto_vrf_keypair_from_seed(
        pk: *mut libc::c_uchar,
        sk: *mut libc::c_uchar,
        seed: *const libc::c_uchar,
    ) -> libc::c_int;
...
extern "C" {
    pub fn crypto_vrf_is_valid_key(pk: *const libc::c_uchar) -> libc::c_int;
}
extern "C" {
    pub fn crypto_vrf_prove(
        proof: *mut libc::c_uchar,
        sk: *const libc::c_uchar,
        m: *const libc::c_uchar,
        mlen: libc::c_ulonglong,
...
extern "C" {
    pub fn crypto_vrf_proof_to_hash(
        hash: *mut libc::c_uchar,
        proof: *const libc::c_uchar,
    ) -> libc::c_int;
}
extern "C" {
    pub fn crypto_vrf_sk_to_pk(pk: *mut libc::c_uchar, skpk: *const libc::c_uchar);
}
extern "C" {
    pub fn crypto_vrf_sk_to_seed(seed: *mut libc::c_uchar, skpk: *const libc::c_uchar);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
