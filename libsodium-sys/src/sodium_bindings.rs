...
fn bindgen_test_layout_crypto_generichash_blake2b_state() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<crypto_generichash_blake2b_state>())).h as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<crypto_generichash_blake2b_state>())).t as *const _ as usize
        },
        64usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<crypto_generichash_blake2b_state>())).f as *const _ as usize
        },
        80usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<crypto_generichash_blake2b_state>())).buf as *const _ as usize
        },
        96usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<crypto_generichash_blake2b_state>())).buflen as *const _
                as usize
        },
        352usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<crypto_generichash_blake2b_state>())).last_node as *const _
                as usize
        },
        360usize,
        concat!(
