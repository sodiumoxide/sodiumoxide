...
mod test {
    ...
    fn test_push_pull() {
        ...
        let c1 = push_state.push(&msg1, None, crypto_secretstream_xchacha20poly1305_TAG_MESSAGE);
        let c2 = push_state.push(&msg2, None, crypto_secretstream_xchacha20poly1305_TAG_PUSH);
        let c3 = push_state.push(&msg3, None, crypto_secretstream_xchacha20poly1305_TAG_FINAL);
        ...
        assert_eq!(t1, crypto_secretstream_xchacha20poly1305_TAG_MESSAGE);
        assert_eq!(t2, crypto_secretstream_xchacha20poly1305_TAG_PUSH);
        assert_eq!(t3, crypto_secretstream_xchacha20poly1305_TAG_FINAL);
        assert_eq!(msg1[..], m1[..]);
        assert_eq!(msg2[..], m2[..]);
        assert_eq!(msg3[..], m3[..]);
    }
    ...
    fn test_push_pull_with_ad() {
        ...
        let (mut push_state, header) = init_push(&key);
        let c1 = push_state.push(&msg1, Some(&ad1), crypto_secretstream_xchacha20poly1305_TAG_MESSAGE);
        let c2 = push_state.push(&msg2, Some(&ad2), crypto_secretstream_xchacha20poly1305_TAG_PUSH);
        let c3 = push_state.push(&msg3, None, crypto_secretstream_xchacha20poly1305_TAG_FINAL);
    ...
    fn test_push_pull_with_rekey() {
        ...
        let (mut push_state, header) = init_push(&key);
        let c1 = push_state.push(&msg1, None, crypto_secretstream_xchacha20poly1305_TAG_MESSAGE);
        let c2 = push_state.push(&msg2, None, crypto_secretstream_xchacha20poly1305_TAG_REKEY);
        let c3 = push_state.push(&msg3, None, crypto_secretstream_xchacha20poly1305_TAG_FINAL);
        ...
        assert_eq!(t1, crypto_secretstream_xchacha20poly1305_TAG_MESSAGE);
        assert_eq!(t2, crypto_secretstream_xchacha20poly1305_TAG_REKEY);
        assert_eq!(t3, crypto_secretstream_xchacha20poly1305_TAG_FINAL);
        assert_eq!(msg1[..], m1[..]);
        assert_eq!(msg2[..], m2[..]);
        assert_eq!(msg3[..], m3[..]);
