...
pub const KEYBYTES: uint = ffi::crypto_auth_hmacsha512256_KEYBYTES as uint;
pub const TAGBYTES: uint = ffi::crypto_auth_hmacsha512256_BYTES as uint;

auth_module!(crypto_auth_hmacsha512256, crypto_auth_hmacsha512256_verify, verify_32)
