...
mod test {
    ...
    fn test_vector_3() {
        ...
        let m = &[0x45, 0x00, 0x00, 0x54, 0xa6, 0xf2, 0x00, 0x00,
        ...
        let k = Key([0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87,
                     ...
                     0x90, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96, 0x97,
                     0x98, 0x99, 0x9a, 0x9b, 0x9c, 0x9d, 0x9e, 0x9f]);
        let n = Nonce([0xa0, 0xa1, 0xa2, 0xa3, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17]);

        let c_expected = &[0x24, 0x03, 0x94, 0x28, 0xb9, 0x7f, 0x41, 0x7e,
    ...
    fn test_vector_4() {
        ...
        let m = &[0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x40, 0x01,
                  0x00, 0x00, 0x00, 0x0a, 0x00];
        let ad = &[0xc0, 0xc1, 0xc2, 0xc3, 0xc4, 0xc5, 0xc6, 0xc7,
        ...
        let c_expected = &[0x61, 0x03, 0x94, 0x70, 0x1f, 0x8d, 0x01, 0x7f, 0x7c,
                           0x12, 0x92, 0x48, 0x89,
                           0x6b, 0x71, 0xbf, 0xe2, 0x52, 0x36, 0xef, 0xd7, 0xcd,
                           0xc6, 0x70, 0x66, 0x90, 0x63, 0x15, 0xb2];
        let c = seal(m, Some(ad), &n, &k);
        assert_eq!(&c[..], &c_expected[..]);
    }
}
