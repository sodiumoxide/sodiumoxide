...
pub fn stream(len: uint,
    ...
    unsafe {
        ...
        crypto_stream_xsalsa20(c.as_mut_ptr(),
...
pub fn stream_xor(m: &[u8],
    ...
    unsafe {
        ...
        crypto_stream_xsalsa20_xor(c.as_mut_ptr(),
                                   m.as_ptr(),
...
pub fn stream_xor_inplace(m: &mut [u8],
                          ...
                          &Key(k): &Key) {
    unsafe {
        crypto_stream_xsalsa20_xor(m.as_mut_ptr(),
                                   m.as_ptr(),
                                   m.len() as c_ulonglong,
                                   n.as_ptr(),
                                   k.as_ptr());
...
fn test_vector_2() {
    ...
    let rs_expected = ~[0xee,0xa6,0xa7,0x25,0x1c,0x1e,0x72,0x91
...
fn test_vector_3() {
    ...
    let c_expected = [0x8e,0x99,0x3b,0x9f,0x48,0x68,0x12,0x73
                     ...
                     ,0xe3,0x55,0xa5];
    assert!(c.slice_from(32) == c_expected);
}
